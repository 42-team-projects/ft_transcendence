...
SECRET_KEY = 'django-insecure-pz9@)p^u_&86@g)0szw!nt=1@-1$hdvj8@qg!l%@)5f#+84_be'
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '10.11.1.2', '10.11.4.8', '10.12.9.4', '10.12.8.4', '10.11.7.2']
...
ASGI_APPLICATION = 'merge.asgi.application' #new
