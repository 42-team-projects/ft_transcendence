    ...
    async connectedCallback() {
        ...
        sendButton.addEventListener("click", () => {
            ...
            if (message.length)
            {
                ...
                websocket.send(JSON.stringify({'message': `currentUser.username sent you a new message.`, 'receiver': this.targetId, 'is_signal': true, 'type': "message", "infos": "/Chat/" + currentUser.username}));
            }
            inputArea.value = '';
        });
    }
